      ...
      <div className="head ">
        ...
        >
          ...
          <div className="btnContanier">
              <button className="Btn" type="submit" onClick={handleSubmitSingle}>Single Player </button>
              <button className="Btn" type="submit" onClick={handleSubmitMulti}>Player vs Player</button>
          </div>
            </div>
      </div>
  );
